  ...
  navbarPage(
    ...
    navbarMenu(
      ...
      tabPanel(
        ...
        # checkboxInput("selectmarkers","Select Markers for Downstream Analysis", choices = NULL, selected = NULL, inline = TRUE),
        pickerInput(
      ...
      tabPanel(
        ...
        # br(),
        # br(),
        h3("PREDICTED PHENOTYPES",
           style={'background-color:#EDF0F1;
                       text-align: center; padding: 25px 0;border: 2px solid #D6D9DC;'}),
        fluidRow(column(12, DTOutput('p20table'))),
        br(),
        br(),
        h3("MAPPING OF FINAL CLUSTERS ONTO META-CLUSTERS - UMAP",
           style={'background-color:#EDF0F1;
                       text-align: center; padding: 25px 0;border: 2px solid #D6D9DC;'}),
        ...
        br(),
        br(),
        h3("MAPPING OF FINAL CLUSTERS ONTO META-CLUSTERS - PCA",
           style={'background-color:#EDF0F1;
                       text-align: center; padding: 25px 0;border: 2px solid #D6D9DC;'}),
