...
########################################################################################################
 ...
 ccolor_schemes <- ini_colorschemes(assay = "scCNV", data = list(data_cell_stats = data_cell_stats, umap_coords = umap_coords))
  ...
  somePNGPath <- paste(cdir,"2SCA_PLOT_scCNV_PLOT_PLOIDY_INFO_MEAN_CELL_PLOIDY_",results$project,".png", sep = "")
  png(somePNGPath, width = 4000, height =3000, units = "px", res = 300)
  print(p)
  dev.off()

  somePNGPath <- paste(cdir,"SCA_PLOT_scCNV_DAPC_COMPONENT12_",results$project,".png", sep = "")
  ...
  somePNGPath <- paste(cdir,"4SCA_PLOT_scCNV_UMAP_COMPONENT12_",results$project,".png", sep = "")
  png(somePNGPath, width = 3000, height =2000, units = "px", res = 300)
  print(p)
  dev.off()
  ...
  somePNGPath <- paste(cdir,"7SCA_PLOT_scCNV_CLUSTER_PROPORTION_BY_SAMPLES_",results$project,".png", sep = "")
  png(somePNGPath, width = 4000, height = 3000, units = "px", res = 300)
  print(p)
  dev.off()
  ...
  somePNGPath <- paste(cdir,"8SCA_PLOT_scCNV_PHYLOGENETIC_TREE_CLUSTERS_",results$project,".png", sep = "")
  png(somePNGPath, width = 3000, height =2000, units = "px", res = 300)
  print(p)
  dev.off()

  saveRDS(results, paste(cdir,"9SCA_DATA_scCNV_RESULT_",results$project,".RDS", sep = ""))
