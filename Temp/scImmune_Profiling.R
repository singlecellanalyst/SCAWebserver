...
########################################################################################################
  ...
  #######################################################################################################################################
  somePDFPath = paste(cdir,"1SCA_PLOT_scIMMUNE_NUMBER_UNIQUE_CLONOTYPES_",project_name,".pdf", sep = "")
  pdf(file=somePDFPath, width=10, height=5,pointsize=12)
  print(p1plots)
  dev.off()

  somePDFPath = paste(cdir,"2SCA_PLOT_scIMMUNE_DISTR_CDR3_LENGTHS_",project_name,".pdf", sep = "")
  pdf(file=somePDFPath, width=10, height=5,pointsize=12)
  print(p2plots)
  dev.off()

  write.csv(imm_pr, paste(cdir,"3SCA_TABLE_scIMMUNE_CLONE_PROPORTIONS_ALL_SAMPLES_ANALYSIS_",project_name,".csv", sep = ""), quote = F, row.names = T)
  write.csv(imm_top, paste(cdir,"3SCA_TABLE_scIMMUNE_TOP_N_MOST_ABUNDANT_CLONOTYPES_PORPORTION_ALL_SAMPLES_ANALYSIS_",project_name,".csv", sep = ""), quote = F, row.names = T)
  write.csv(imm_rare, paste(cdir,"3SCA_TABLE_scIMMUNE_RELATIVE_ABUNDANCE_RARE_CLONOTYPES_PORPORTION_ALL_SAMPLES_ANALYSIS_",project_name,".csv", sep = ""), quote = F, row.names = T)
  write.csv(imm_hom, paste(cdir,"3SCA_TABLE_scIMMUNE_CLONALSPACE_HOMEOSTASIS_ALL_SAMPLES_ANALYSIS_",project_name,".csv", sep = ""), quote = F, row.names = T)

  somePDFPath = paste(cdir,"4SCA_PLOT_scIMMUNE_TOP_CLONAL_PROPORTIONS_",project_name,".pdf", sep = "")
  pdf(file=somePDFPath, width=12, height=5.3,pointsize=12)
  print(p4plots)
  dev.off()

  somePDFPath = paste(cdir,"5SCA_PLOT_scIMMUNE_RARE_CLONAL_PROPORTIONS_",project_name,".pdf", sep = "")
  pdf(file=somePDFPath, width=12, height=5.3,pointsize=12)
  print(p5plots)
  dev.off()

  somePDFPath = paste(cdir,"6SCA_PLOT_scIMMUNE_CLONALSPACE_HOMEOSTASIS_",project_name,".pdf", sep = "")
  pdf(file=somePDFPath, width=12, height=5.3,pointsize=12)
  print(p6plots)
  dev.off()

  somePDFPath = paste(cdir,"7SCA_PLOT_scIMMUNE_REPERTOIRE_OVERLAPS_",project_name,".pdf", sep = "")
  pdf(file=somePDFPath, width=12, height=5.3,pointsize=12)
  print(p7plots)
  dev.off()

  write.csv(all_gene_usage, paste(cdir,"8SCA_TABLE_scIMMUNE_GENE_USAGE_",project_name,".csv", sep = ""), quote = F, row.names = T)

  somePDFPath = paste(cdir,"9SCA_PLOT_scIMMUNE_GENE_USAGE_BY_CELL_TYPES_",project_name,".pdf", sep = "")
  ...
  somePDFPath = paste(cdir,"10SCA_PLOT_scIMMUNE_GENE_USAGE_JS-DIVERGENCE_CORRELATION_",project_name,".pdf", sep = "")
  pdf(file=somePDFPath, width=12, height=5.3,pointsize=12)
  ...
  somePDFPath = paste(cdir,"11SCA_PLOT_scIMMUNE_HCLUSTERING_KMEANS_",project_name,".pdf", sep = "")
  pdf(file=somePDFPath, width=12, height=5.3,pointsize=12)
  ...
  somePDFPath = paste(cdir,"12SCA_PLOT_scIMMUNE_GENE_WISE_SAMPLE_DISTANCE_PCA_MDS_",project_name,".pdf", sep = "")
  pdf(file=somePDFPath, width=12, height=5.3,pointsize=12)
  ...
  somePDFPath = paste(cdir,"13SCA_PLOT_scIMMUNE_SPECTRATYPE_CLONALTYPE_",project_name,".pdf", sep = "")
  pdf(file=somePDFPath, width=12, height=5.3,pointsize=12)
  ...
  somePDFPath = paste(cdir,"14SCA_PLOT_scIMMUNE_DIVERSITY_ESTIMATES_",project_name,".pdf", sep = "")
  pdf(file=somePDFPath, width=10, height=6.7,pointsize=12)
  ...
  somePDFPath = paste(cdir,"15SCA_PLOT_scIMMUNE_ALLUVIAL_TOP_10_MOST_ABUNDANT_CLONOTYPES_",project_name,".pdf", sep = "")
  ...
  somePDFPath = paste(cdir,"15SCA_PLOT_scIMMUNE_TOP_10_AA_KMER_SIZE_10_TO_20_",project_name,".pdf", sep = "")
  ...
  for(i in 10:20){
    ...
    somePDFPath = paste(cdir,"15SCA_PLOT_scIMMUNE_AA_SEQUENCE_MOTIF_KMER_SIZE_",project_name,".pdf", sep = "")
  ...
  somePDFPath = paste(cdir,"16SCA_PLOT_scIMMUNE_CIRCOS_DIAGRAM_REPERTOIRE_OVERLAPS_",project_name,".pdf", sep = "")
  ...
  somePDFPath = paste(cdir,"17SCA_PLOT_scIMMUNE_HEATMAP_REPERTOIRE_OVERLAPS_",project_name,".pdf", sep = "")
  pdf(file=somePDFPath, width=10, height=7.5, pointsize=12)
  print(p17plots)
  dev.off()

  somePDFPath = paste(cdir,"18SCA_PLOT_scIMMUNE_CLONOTYPE_ABUNDANCE_",project_name,".pdf", sep = "")
  pdf(file=somePDFPath, width=12, height=5.3, pointsize=12)
  ...
  for(i in 1:length(p19data)){
    x <- p19data[[i]]
    write.csv(x, paste(cdir,"19SCA_TABLE_scIMMUNE_CONTIG_ABUNDANCE_",names(p19data)[i],"_",project_name,".csv", sep = ""), quote = F, row.names = T)
  }

  somePDFPath = paste(cdir,"20SCA_PLOT_scIMMUNE_CDR3_CONTIG_LENGTH_AA_NT_",project_name,".pdf", sep = "")
  ...
  somePDFPath = paste(cdir,"21SCA_PLOT_scIMMUNE_ALLUVIAL_CLONOTYPES_PROPORTIONS_CDR3_AA_",project_name,".pdf", sep = "")
  ...
  somePDFPath = paste(cdir,"22SCA_PLOT_scIMMUNE_CONTIG_V_GENE_USAGE_",project_name,".pdf", sep = "")
  ...
  somePDFPath = paste(cdir,"23SCA_PLOT_scIMMUNE_CLONAL_HOMEOSTASIS_PROPORTION_",project_name,".pdf", sep = "")
  pdf(file=somePDFPath, width=12, height=5.3, pointsize=12)
  ...
  somePDFPath = paste(cdir,"24SCA_PLOT_scIMMUNE_MORISITA_INDEX_CLONAL_OVERLAP_",project_name,".pdf", sep = "")
  ...
  somePDFPath = paste(cdir,"26SCA_PLOT_scIMMUNE_CLONAL_SAMPLE_DIVERSITY_",project_name,".pdf", sep = "")
  pdf(file=somePDFPath, width=10, height=6.7, pointsize=12)
  ...
  somePDFPath = paste(cdir,"27SCA_PLOT_scIMMUNE_UMAP_BY_SAMPLE_",project_name,".pdf", sep = "")
  pdf(file=somePDFPath, width=12, height=8, pointsize=12)
  print(p27plots)
  dev.off()

  somePDFPath = paste(cdir,"28SCA_PLOT_scIMMUNE_UMAP_BY_DATA_TYPE_",project_name,".pdf", sep = "")
  pdf(file=somePDFPath, width=12, height=8, pointsize=12)
  print(p28plots)
  dev.off()

  somePDFPath = paste(cdir,"29SCA_PLOT_scIMMUNE_UMAP_BY_CLUSTER_",project_name,".pdf", sep = "")
  pdf(file=somePDFPath, width=12, height=8, pointsize=12)
  print(p29plots)
  dev.off()

  somePDFPath = paste(cdir,"30SCA_PLOT_scIMMUNE_UMAP_BY_GROUP_CLUSTER_",project_name,".pdf", sep = "")
  pdf(file=somePDFPath, width=12, height=8, pointsize=12)
  print(p30plots)
  dev.off()

  somePDFPath = paste(cdir,"31SCA_PLOT_scIMMUNE_UMAP_BY_CELL_TYPE_",project_name,".pdf", sep = "")
  pdf(file=somePDFPath, width=12, height=8, pointsize=12)
  print(p31plots)
  dev.off()

  somePDFPath = paste(cdir,"32SCA_PLOT_scIMMUNE_UMAP_BY_GROUP_CELL_TYPE_",project_name,".pdf", sep = "")
  pdf(file=somePDFPath, width=12, height=9, pointsize=12)
  print(p32plots)
  dev.off()

  somePDFPath = paste(cdir,"33SCA_PLOT_scIMMUNE_UMAP_BY_CLONOTYPE_",project_name,".pdf", sep = "")
  pdf(file=somePDFPath, width=12, height=6.7, pointsize=12)
  print(p33plots)
  dev.off()

  somePDFPath = paste(cdir,"34SCA_PLOT_scIMMUNE_CLONOTYPES_BY_CELL_TYPE_CLONECALL_",project_name,".pdf", sep = "")
  pdf(file=somePDFPath, width=14, height=6, pointsize=12)
  print(p34plots)
  dev.off()

  somePDFPath = paste(cdir,"35SCA_PLOT_scIMMUNE_CLONOTYPES_BY_CELL_TYPE_GROUP_DATA_TYPE_CLONECALL_",project_name,".pdf", sep = "")
  pdf(file=somePDFPath, width=18, height=10, pointsize=12)
  print(p35plots)
  dev.off()

  somePDFPath = paste(cdir,"36SCA_PLOT_scIMMUNE_CLONO_DIVERISITY_BY_CELL_TYPE_CLONECALL_",project_name,".pdf", sep = "")
  pdf(file=somePDFPath, width=10, height=6.7, pointsize=12)
  ...
  somePDFPath = paste(cdir,"37SCA_PLOT_scIMMUNE_CLONAL_OVERLAY_CLUSTERS_",project_name,".pdf", sep = "")
  pdf(file=somePDFPath, width=18, height=6.7, pointsize=12)
  print(p37plots)
  dev.off()

  somePDFPath = paste(cdir,"38SCA_PLOT_scIMMUNE_CLONAL_OVERLAY_CELL_TYPES_",project_name,".pdf", sep = "")
  pdf(file=somePDFPath, width=18, height=6.7, pointsize=12)
  print(p38plots)
  dev.off()

  somePDFPath = paste(cdir,"39SCA_PLOT_scIMMUNE_CLONAL_NETWORK_CLUSTERS_",project_name,".pdf", sep = "")
  pdf(file=somePDFPath, width=14, height=8, pointsize=12)
  print(p39plots)
  dev.off()

  saveRDS(data, paste(cdir,"40SCA_DATA_scIMMUNE_INTEGRATED_DATA_",project_name,".RDS", sep = ""))
