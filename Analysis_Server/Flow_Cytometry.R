...
########################################################################################################
  ...
  somePDFPath <- paste(cdir,"1SCA_PLOT_ASINH_DENSITY_PLOT_CHANNELS_",project_name,".pdf", sep = "")
  ...
  for(j in 1:length(channels)){
    ...
    # somePNGPath <- paste(cdir,"1SCA_PLOT_FLOW_ASINH_DENSITY_PLOT_CHANNEL_",channels[[j]],"_",project_name,".png", sep = "")
  ...
  data_summary <- NULL
  k <- 1
  somePDFPath <- paste(cdir,"2SCA_PLOT_FLOW_GATING_STRATEGY_PART1_",project_name,".pdf", sep = "")
  pdf(file=somePDFPath, width=10, height=7.5,pointsize=12)
  for(i in 1:length(fs_data)){
    ...
    if(length(colnames(fs_data[[i]])[grep("FSC.*A|SSC.*A", colnames(fs_data[[i]]), ignore.case = T)]) == 2){
      ...
      # somePNGPath <- paste(cdir,"2SCA_PLOT_FLOW_GATING_STRATEGY_PART1_",chnlx,"_VS_",chnly,"_",cname,".png", sep = "")
      # png(somePNGPath, width = 4000, height =3000, units = "px", res = 300)
      print("before plot")
      print(p2plots[[k]])
      print("after plot")
    ...
    if(length(colnames(fs_data[[i]])[grep("FSC.*A|FSC.*H", colnames(fs_data[[i]]), ignore.case = T)]) == 2){
      ...
      names(p2plots)[k] <- paste(cname,lastGate, sep = ":")
      # somePNGPath <- paste(cdir,"2SCA_PLOT_FLOW_GATING_STRATEGY_PART2_",chnlx,"_VS_",chnly,"_",cname,".png", sep = "")
      # png(somePNGPath, width = 4000, height =3000, units = "px", res = 300)
      print(p2plots[[k]])
      # dev.off()
      k <- k + 1
    ...
    if(length(colnames(fs_data[[i]])[grep("SSC.*W|SSC.*H", colnames(fs_data[[i]]), ignore.case = T)]) == 2){
      ...
      names(p2plots)[k] <- paste(cname,lastGate, sep = ":")
      # somePNGPath <- paste(cdir,"2SCA_PLOT_FLOW_GATING_STRATEGY_PART3_",chnlx,"_VS_",chnly,"_",cname,".png", sep = "")
      # png(somePNGPath, width = 4000, height =3000, units = "px", res = 300)
      print(p2plots[[k]])
      # dev.off()
      k <- k + 1
    ...
    if(length(colnames(fs_data[[i]])[grep("FSC.*H|FSC.*W", colnames(fs_data[[i]]), ignore.case = T)]) == 2){
      ...
      names(p2plots)[k] <- paste(cname,lastGate, sep = ":")
      # somePNGPath <- paste(cdir,"2SCA_PLOT_FLOW_GATING_STRATEGY_PART4_",chnlx,"_VS_",chnly,"_",cname,".png", sep = "")
      # png(somePNGPath, width = 4000, height =3000, units = "px", res = 300)
      print(p2plots[[k]])
      # dev.off()
      k <- k + 1
  ...
  write.csv(data_summary, paste(cdir, "SCA_TABLE_FLOW_FILTERING_SUMMARY_",project_name,".csv",sep = ""),row.names = F)
  ...
  p3plots <- NULL
  somePDFPath <- paste(cdir,"3SCA_PLOT_FLOW_POST_FILTERING_ASINH_DENSITY_PLOT_CHANNELS_",project_name,".pdf", sep = "")
  pdf(file=somePDFPath, width=10, height=7.5,pointsize=12)
  for(j in 1:length(channels)){
    ...
    # somePNGPath <- paste(cdir,"3SCA_PLOT_FLOW_POST_FILTERING_ASINH_DENSITY_PLOT_CHANNEL_",channels[[j]],"_",project_name,".png", sep = "")
    # png(somePNGPath, width = 4000, height =3000, units = "px", res = 300)
    print(p1plots[[j]])
  }
  dev.off()
  ...
  somePDFPath <- paste(cdir,"4SCA_PLOT_FLOW_CELL_COUNT_SUMMARY_",project_name,".pdf", sep = "")
  pdf(file=somePDFPath, width=10, height=7.5,pointsize=12)
  print(p4plots)
  dev.off()
  ...
  somePDFPath <- paste(cdir,"5SCA_PLOT_FLOW_SAMPLE_MDS_ASINH_MEDIAN_",project_name,".pdf", sep = "")
  pdf(file=somePDFPath, width=10, height=7.5,pointsize=12)
  print(p5plots)
  dev.off()
  ...
  somePDFPath <- paste(cdir,"6SCA_PLOT_FLOW_SAMPLE_PCA_ASINH_MEDIAN_",project_name,".pdf", sep = "")
  pdf(file=somePDFPath, width=10, height=7.5,pointsize=12)
  print(p6plots)
  dev.off()
  ...
  somePDFPath <- paste(cdir,"7SCA_PLOT_FLOW_HEATMAP_SAMPLE_SCALED_ASINH_MEDIAN_EXPRESSION_",project_name,".pdf", sep = "")
  ...
  somePDFPath <- paste(cdir,"8SCA_PLOT_FLOW_DENDROGRAM_SAMPLES_",project_name,".pdf", sep = "")
  pdf(file=somePDFPath, width=10, height=6.7,pointsize=12)
  par(mar=c(3,4,1,6))
  ...
  somePDFPath <- paste(cdir,"9SCA_PLOT_FLOW_BOXPLOT_NRS_SCORE_ASINH_MARKER_",project_name,".pdf", sep = "")
  pdf(file=somePDFPath, width=10, height=6.7,pointsize=12)
  print(p9plots)
  dev.off()
  ...
  somePDFPath <- paste(cdir,"10SCA_PLOT_FLOW_CONSENSUS_",project_name,".pdf", sep = "")
...
dev.off()
  ...
  somePDFPath <- paste(cdir,"10SCA_PLOT_FLOW_PAC_CHOSEN_",chosen_k,"_BASED_ON_CONSENSUS_CLUSTERS_",project_name,".pdf", sep = "")
  pdf(file=somePDFPath, width=10, height=7.5,pointsize=12)
  print(p10plots)
  dev.off()
  ...
  somePDFPath <- paste(cdir,"11SCA_PLOT_FLOW_UMAP_CLUSTERS_",project_name,".pdf", sep = "")
  pdf(file=somePDFPath, width=10, height=7.5,pointsize=12)
  print(p11plots)
  dev.off()
  ...
  # somePDFPath <- paste(cdir,"12SCA_PLOT_FLOW_UMAP_CLUSTERS_BY_SAMPLES_",project_name,".pdf", sep = "")
  # pdf(file=somePDFPath, width=12, height=ceiling(length(unique(plotx$SAMPLE_ID))/4)*2.4,pointsize=12)
  somePNGPath = paste(cdir,"12SCA_PLOT_FLOW_UMAP_CLUSTERS_BY_SAMPLES_",project_name,".png", sep = "")
  ...
  # somePDFPath <- paste(cdir,"13SCA_PLOT_FLOW_PCA_CLUSTERS_",project_name,".pdf", sep = "")
  # pdf(file=somePDFPath, width=10, height=7.5,pointsize=12)
  somePNGPath = paste(cdir,"13SCA_PLOT_FLOW_PCA_CLUSTERS_",project_name,".png", sep = "")
  png(somePNGPath, width = 4000, height = 3000,units = "px", res = 300)
  print(p13plots)
  dev.off()

  p14data <- plot_median
  somePDFPath <- paste(cdir,"14SCA_PLOT_FLOW_HEATMAP_CLUSTER_SCALED_ASINH_MEDIAN_EXPRESSION_",project_name,".pdf", sep = "")
  ...
  # somePDFPath <- paste(cdir,"15SCA_PLOT_FLOW_UMAP_MARKER_EXPRESSIONS_",project_name,".pdf", sep = "")
  # pdf(file=somePDFPath, width=10, height=3*ceiling(length(unique(melt_data$Marker))/3),pointsize=12)
  somePNGPath = paste(cdir,"15SCA_PLOT_FLOW_UMAP_MARKER_EXPRESSIONS_",project_name,".png", sep = "")
  ...
  somePDFPath <- paste(cdir,"16SCA_PLOT_FLOW_SAMPLE_PROPORTIONS_IN_CLUSTERS_",project_name,".pdf", sep = "")
  pdf(file=somePDFPath, width=10, height=7.5,pointsize=12)
  print(p16plots)
  dev.off()
  ...
  somePDFPath <- paste(cdir,"17SCA_PLOT_FLOW_VIOLIN_MARKERS_IN_CLUSTERS_",project_name,".pdf", sep = "")
  pdf(file=somePDFPath, width=10, height=7.5,pointsize=12)
  print(p17plots)
  dev.off()

  saveRDS(data, paste(cdir, "18SCA_DATA_FLOW_FILTERED_DATA_COMBINED_",project_name,".RDS", sep = ""))
