...
library("umap")
  ...
  somePNGPath <- paste(cdir,"1SCA_PLOT_CyTOF_SAMPLE_CELL_SUMMARY_",project_name,".png", sep = "")
  ...
  somePNGPath <- paste(cdir,"2SCA_PLOT_CyTOF_MARKER_DENSITIES_",project_name,".png", sep = "")
  ...
  somePNGPath <- paste(cdir,"3SCA_PLOT_CyTOF_MDS_SAMPLE_DISTANCE_",project_name,".png", sep = "")
  ...
  somePNGPath <- paste(cdir,"4SCA_PLOT_CyTOF_PCA_SAMPLE_DISTANCE_",project_name,".png", sep = "")
  png(somePNGPath, width = 4000, height = 2500, units = "px", res = 300)
  print(p4plots)
  dev.off()
  ...
  somePNGPath <- paste(cdir,"5SCA_PLOT_CyTOF_HEATMAP_SAMPLE_SCALED_ASINH_MEDIAN_EXPRESSION_",project_name,".png", sep = "")
  ...
  somePNGPath <- paste(cdir,"6SCA_PLOT_CyTOF_BOXPLOT_MARKERS_BY_GROUP_",project_name,".png", sep = "")
  ...
  somePNGPath <- paste(cdir,"7SCA_PLOT_CyTOF_DENDROGRAM_SAMPLES_",project_name,".png", sep = "")
  ...
  somePNGPath <- paste(cdir,"8SCA_PLOT_CyTOF_NRS_RANKING_ALL_MARKERS_",project_name,".png", sep = "")
  ...
  codes <- som$map$codes
  nmc <- 90
  somePDFPath <- paste(cdir,"9SCA_PLOT_CyTOF_CONSENSUS_",project_name,".pdf", sep = "")
  ...
  somePNGPath <- paste(cdir,"9SCA_PLOT_CyTOF_PAC_ELBOW_PLOT_CHOSEN_CLUSTER_NUMBER_",chosen_k,"_CLUSTERS_",project_name,".png", sep = "")
  ...
  somePNGPath <- paste(cdir,"10SCA_PLOT_CyTOF_HEATMAP_CLUSTERS_ASINH_MEDIAN_",project_name,".png", sep = "")
  ...
  somePNGPath <- paste(cdir,"11SCA_PLOT_CyTOF_BOXPLOT_CLUSTERS_BY_GROUP_",project_name,".png", sep = "")
  ...
  somePNGPath <- paste(cdir,"12SCA_PLOT_CyTOF_UMAP_BY_GROUP_",project_name,".png", sep = "")
  png(somePNGPath, width = 4000, height =2500, units = "px", res = 300)
  print(p12plots)
  dev.off()
  ...
  somePNGPath <- paste(cdir,"13SCA_PLOT_CyTOF_UMAP_BY_SAMPLE_",project_name,".png", sep = "")
  ...
  somePNGPath <- paste(cdir,"14SCA_PLOT_CyTOF_UMAP_BY_CLUSTER_",project_name,".png", sep = "")
  png(somePNGPath, width = 4000, height = 2500, units = "px", res = 300)
  print(p14plots)
  dev.off()
  ...
  somePNGPath <- paste(cdir,"15SCA_PLOT_CyTOF_PCA_BY_CLUSTER_",project_name,".png", sep = "")
  png(somePNGPath, width = 4000, height = 2500, units = "px", res = 300)
  print(p15plots)
  dev.off()
  ...
  for(i in 1:length(group_colors)){
    ...
    somePNGPath <- paste(cdir,"16SCA_PLOT_CyTOF_UMAP_ASINH_EXPRESSION_MARKER_",names(group_colors)[i],"_",project_name,".png", sep = "")
  ...
  somePNGPath <- paste(cdir,"17SCA_PLOT_CyTOF_PROPORTION_OF_SAMPLES_IN_EACH_CLUSTER_",project_name,".png", sep = "")
  ...
  somePNGPath <- paste(cdir,"18SCA_PLOT_CyTOF_PROPORTION_OF_CLUSTERS_IN_EACH_SAMPLE_",project_name,".png", sep = "")
  ...
  write.csv(p20data, paste(cdir, "20SCA_PLOT_TABLE_DATA_CLUSTER_AUTO_PHENOTYPES_PREDICTION_",project_name,".csv",sep = ""),row.names = F)
  ...
  somePNGPath <- paste(cdir,"19SCA_PLOT_CyTOF_tSNE_SOM_NODES_",project_name,".png", sep = "")
  ...
  somePNGPath <- paste(cdir,"21SCA_PLOT_CyTOF_UMAP_SOM_NODES_",project_name,".png", sep = "")
  png(somePNGPath, width = 4000, height =3000, units = "px", res = 400)
  print(p21plots)
  dev.off()
  ...
  somePNGPath <- paste(cdir,"22SCA_PLOT_CyTOF_PCA_SOM_NODES_",project_name,".png", sep = "")
  png(somePNGPath, width = 4000, height =3000, units = "px", res = 400)
  print(p22plots)
  dev.off()

  saveRDS(data, paste(cdir,"23SCA_DATA_CyTOF_",project_name,".RDS", sep = ""))
