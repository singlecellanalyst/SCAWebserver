...
########################################################################################################
  ...
  for(i in 1:length(sample_files)){
    ...
    somePDFPath = paste(cdir,"1SCA_PLOT_VIOLIN_IMAGE_FEATURES_",annot_names[i],"_",project_name,".pdf", sep = "")
    ...
    somePDFPath = paste(cdir,"2SCA_PLOT_SPATIALLY_VARIABLE_FEATURES_",annot_names[i],"_",project_name,".pdf", sep = "")
    pdf(file=somePDFPath, width=10, height=7.5,pointsize=12)
    print(p1/p2)
    dev.off()
    ...
    somePDFPath = paste(cdir,"3SCA_PLOT_UMAP_ALL_SAMPLES_",annot_names[i],"_",project_name,".pdf", sep = "")
    pdf(file=somePDFPath, width=10, height=7.5,pointsize=12)
    print(p)
    dev.off()
    ...
    somePDFPath = paste(cdir,"4SCA_PLOT_tSNE_ALL_SAMPLES_",annot_names[i],"_",project_name,".pdf", sep = "")
    pdf(file=somePDFPath, width=10, height=7.5,pointsize=12)
    print(p)
    dev.off()
    ...
    somePDFPath = paste(cdir,"5SCA_PLOT_SLIDE_CLUSTERS_",annot_names[i],"_",project_name,".pdf", sep = "")
    pdf(file=somePDFPath, width=10, height=7.5,pointsize=12)
    print(p)
    dev.off()
    ...
    Idents(current) <- "seurat_clusters"
    DefaultAssay(current) <- "SCT"
    somePDFPath = paste(cdir,"6SCA_PLOT_SLIDE_IMAGE_BY_EACH_CLUSTER_",annot_names[i],"_",project_name,".pdf", sep = "")
    ...
    somePDFPath = paste(cdir,"8SCA_PLOT_UMAP_SAMPLE_IMAGE_CLUSTER_",annot_names[i],"_",project_name,".pdf", sep = "")
    ...
    somePDFPath = paste(cdir,"9SCA_PLOT_SPATIALLY_TOP_FEATURES_",annot_names[i],"_",project_name,".pdf", sep = "")
    pdf(file=somePDFPath, width=10, height=5,pointsize=12)
    ...
    write.table(current_de_markers, paste(cdir,"10SCA_PLOT_TABLE_DATA_CLUSTER_DEG_",annot_names[i],"_",project_name, ".txt", sep = ""), row.names = F, quote = F, sep = "\t")
    ...
    somePDFPath = paste(cdir,"11SCA_PLOT_VIOLINPLOT_TOP_MARKERS_",annot_names[i],"_",project_name,".pdf", sep = "")
    ...
    somePDFPath = paste(cdir,"12SCA_PLOT_UMAP_AUTO_CELLTYPE_ANNOTATIONS_",annot_names[i],"_",project_name,".pdf", sep = "")
    ...
    somePDFPath = paste(cdir,"13SCA_PLOT_scRNASEQ_UMAP_BY_CLUSTERS_",pheno_data[i,"SAMPLE_ID"],"_",project_name,".pdf", sep = "")
    ...
    somePDFPath = paste(cdir,"14SCA_PLOT_scRNASEQ_tSNE_BY_CLUSTERS_",pheno_data[i,"SAMPLE_ID"],"_",project_name,".pdf", sep = "")
    pdf(file=somePDFPath, width=14, height=10,pointsize=10)
    ...
    somePDFPath = paste(cdir,"15SCA_PLOT_scRNASEQ_UMAP_TSNE_AUTO_CELL_TYPE_",pheno_data[i,"SAMPLE_ID"],"_",project_name,".pdf", sep = "")
    ...
    somePDFPath = paste(cdir,"16SCA_PLOT_scRNASEQ_IMAGE_BY_scRNASEQ_PREDICTION_SCORES_",pheno_data[i,"SAMPLE_ID"],"_",project_name,".pdf", sep = "")
    ...
    somePDFPath = paste(cdir,"17SCA_PLOT_scRNASEQ_VIOLIN_PREDICTION_SCORES_CLUSTERS_",project_name,".pdf", sep = "")
...
saveRDS(data_current, paste(cdir,"13SCA_SPATIAL_DATA_",annot_names[i],"_",project_name,".RDS", sep = ""))
